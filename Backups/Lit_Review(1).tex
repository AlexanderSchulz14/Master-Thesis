...
%%%%%%%%%%% Überarbeitung %%%%%%%%%%%
It is again important to note the relevance of monetary policy to enhance one's understanding of the yield curve, especially highlighting the relevance of the yield curve for conducting monetary policy at the zero lower bound. 
...
% Some of the latest contributions in the corresponding literature have mainly focused on how to improve the modelling strategy of the term structure either using Nelson-Siegel or a similar approach 
...
% Their approach allows for flexible shrinkage priors and stochastic volatility, enhancing the model's ability to capture complex dynamics in yield curves. 
